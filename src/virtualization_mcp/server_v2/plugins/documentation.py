...
class DocumentationPlugin(BasePlugin):
    ...
    def _document_route(self, route) -> EndpointDocumentation | None:
    ...
    def _extract_parameter_info(self, param) -> ParameterDocumentation | None:
    ...
    def _model_to_schema(self, model: type[BaseModel]) -> dict[str, Any]:
        ...
        for field_name, field in model.__fields__.items():
            field_schema = {"type": self._get_type_name(field.type_)}
