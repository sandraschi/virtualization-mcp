...
class TemplateManager:
    ...
    def _get_default_templates(self) -> dict[str, Any]:
        ...
        return {
            "ubuntu-dev": {
                ...
                "post_install": ["docker", "git", "nodejs", "python3"],
                "recommended_snapshots": ["fresh-install", "dev-tools-ready"],
            },
            "windows-test": {
                ...
                "post_install": ["chocolatey", "visual-studio-code", "git"],
                "recommended_snapshots": ["clean-windows", "dev-ready"],
            },
            "minimal-linux": {
                "os_type": "Ubuntu_64",
                "memory_mb": 1024,
                ...
                "use_cases": ["CLI testing", "Service validation", "Quick experiments"],
            },
            "database-server": {
                "os_type": "Ubuntu_64",
                "memory_mb": 6144,
                ...
                "post_install": ["postgresql", "mysql-server", "redis-server"],
                "port_forwards": [
            ...
            "web-server": {
                ...
                "post_install": ["nginx", "php8.1", "php8.1-fpm", "certbot"],
                "port_forwards": [
            ...
            "docker-host": {
                ...
                "post_install": ["docker", "docker-compose", "portainer"],
                "port_forwards": [
            ...
            "security-test": {
                ...
                "post_install": ["nmap", "wireshark", "metasploit-framework"],
                "use_cases": [
                    "Penetration testing",
    ...
    def get_template_for_use_case(self, use_case: str) -> list[dict[str, Any]]:
        ...
        for name, config in self.templates.items():
            ...
            if (
                use_case_lower in template_use_cases
                or use_case_lower in description
                or any(use_case_lower in pkg for pkg in packages)
            ):
