...
async def list_storage_controllers(vm_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to list storage controllers: {e.stderr}"
        }
...
async def create_storage_controller(
    ...
    try:
        ...
        cmd = [
            ...
            "--add", controller_type.lower(),
            "--portcount", str(port_count),
            "--bootable", "on" if bootable else "off"
        ]
        ...
        return {
            "status": "error",
            "message": f"Failed to create storage controller: {e.stderr}"
        }

async def remove_storage_controller(
    vm_name: str,
    controller_name: str
) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to remove storage controller: {e.stderr}"
        }
...
async def attach_disk(
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to attach disk: {e.stderr}"
        }
...
async def mount_iso(
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to mount ISO: {e.stderr}"
        }
...
async def unmount_iso(
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to unmount ISO: {e.stderr}"
        }
...
async def list_disks(vm_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to list disks: {e.stderr}"
        }
...
async def create_disk(
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to create disk: {e.stderr}"
        }
...
async def get_disk_info(disk_identifier: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to get disk info: {e.stderr}"
        }
...
async def resize_disk(disk_identifier: str, new_size_mb: int) -> Dict[str, Any]:
    ...
    try:
        ...
        if disk_info["disk_info"].get("State") == "locked":
            return {
                "status": "error",
                "message": "Cannot resize a disk that is in use"
            }
        ...
        return {
            "status": "error",
            "message": f"Failed to resize disk: {e.stderr}"
        }
    ...
    try:
        ...
        if not disk_format:
            ...
            if not disk_format:
                return {
                    "status": "error",
                    "message": "Could not determine source disk format"
                }
        ...
        return {
            "status": "error",
            "message": f"Failed to clone disk: {e.stderr}"
        }
...
async def delete_disk(disk_identifier: str, force: bool = False) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "success",
            "message": f"Disk {disk_identifier} deleted successfully"
        }
