...
async def get_vm_info(vm_name: str) -> dict[str, Any]:
    ...
    try:
        ...
        return {"status": "success", "vm_info": info}
...
async def create_vm(
    ...
    if not isinstance(memory_mb, int) or memory_mb < 128:
        return {"status": "error", "message": "Memory must be at least 128MB"}

    if not isinstance(cpu_count, int) or cpu_count < 1 or cpu_count > 32:
        return {"status": "error", "message": "CPU count must be between 1 and 32"}
    ...
    try:
        ...
        if disk_size_gb > 0:
            create_disk_cmd = [
                ...
                disk_path,
                "--size",
                str(disk_size_gb * 1024),  # Convert GB to MB
                "--format",
                "VDI",
            ]
...
async def stop_vm(vm_name: str, force: bool = False, timeout: int = 30) -> dict[str, Any]:
    """
    ...
    try:
        if force:
            ...
            try:
                ...
                return {"status": "success", "message": f"VM '{vm_name}' was gracefully shut down"}
...
# Export the public API
async def delete_vm(vm_name: str, delete_files: bool = True) -> dict[str, Any]:
    """
    ...
    try:
        ...
        return {
            "status": "success",
            "message": f"VM '{vm_name}' has been deleted"
            + (" with all associated files" if delete_files else " (files preserved)"),
        }
...
async def clone_vm(
    ...
    if not new_name or not isinstance(new_name, str):
        return {"status": "error", "message": "New VM name must be a non-empty string"}
...
async def modify_vm(
    ...
    nic1: str | None = None,
    nictype1: str | None = None,
    nic2: str | None = None,
    nictype2: str | None = None,
    nic3: str | None = None,
    nictype3: str | None = None,
    nic4: str | None = None,
    nictype4: str | None = None,
    audio: bool | None = None,
    clipboard: str | None = None,
    draganddrop: str | None = None,
    vrde: bool | None = None,
    vrde_port: int | None = None,
    vrde_address: str | None = None,
    vrde_auth_type: str | None = None,
    vrde_auth_library: str | None = None,
    vrde_property: dict[str, str] | None = None,
    **extra_params,
) -> dict[str, Any]:
    """
    Modify VM settings.
    ...
    try:
        ...
        if memory_mb is not None:
            if not isinstance(memory_mb, int) or memory_mb < 4:
                return {"status": "error", "message": "Memory must be at least 4MB"}
        ...
        if vram_mb is not None:
            if not isinstance(vram_mb, int) or vram_mb < 1 or vram_mb > 256:
                return {"status": "error", "message": "VRAM must be between 1MB and 256MB"}
...
async def pause_vm(vm_name: str) -> dict[str, Any]:
    ...
    try:
        ...
        return {"status": "success", "message": f"VM '{vm_name}' has been paused"}
...
async def resume_vm(vm_name: str) -> dict[str, Any]:
    ...
    try:
        ...
        return {"status": "success", "message": f"VM '{vm_name}' has been resumed"}
...
async def reset_vm(vm_name: str, reset_type: str = "hard") -> dict[str, Any]:
    """
    ...
    try:
        ...
        return {"status": "success", "message": f"VM '{vm_name}' has been {reset_type} reset"}
