...
async def _handle_start_vm(vm_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
...
async def _handle_stop_vm(vm_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
...
async def _handle_delete_vm(vm_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
...
async def _handle_reset_vm(vm_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
...
async def _handle_pause_vm(vm_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
...
async def _handle_resume_vm(vm_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
...
async def _handle_get_vm_info(vm_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
    """Handle get VM info action."""
    if not vm_name:
        return {
            "success": False,
            "action": "info",
            "error": "vm_name is required for info action"
        }
