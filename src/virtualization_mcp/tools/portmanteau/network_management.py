...
async def _handle_remove_network(network_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
...
async def _handle_list_adapters(vm_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
