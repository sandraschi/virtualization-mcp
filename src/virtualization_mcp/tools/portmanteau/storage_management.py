    ...
    async def storage_management(
        ...
        try:
            ...
            if action == "list_controllers":
                ...
                return await _handle_attach_disk(
                    vm_name=vm_name,
                    disk_path=disk_path,
                    **kwargs
                )
...
async def _handle_list_controllers(vm_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
...
async def _handle_list_disks(vm_name: Optional[str] = None, **kwargs) -> Dict[str, Any]:
