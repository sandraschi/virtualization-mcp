    ...
    try:
        ...
        system_info = {
            ...
            "system": {
                ...
                "virtualbox_version": vbox_version.get("version") if vbox_version.get("status") == "success" else "Unknown"
            }
        }
...
async def get_vbox_info() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to get VirtualBox information: {str(e)}"
        }
...
async def list_ostypes() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to list OS types: {e.stderr}"
        }
...
async def list_extpacks() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to list extension packs: {e.stderr}"
        }
...
async def _get_vbox_version() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "error",
            "message": f"Failed to get VirtualBox version: {e.stderr}"
        }
    ...
    try:
        ...
        return {
            "cpu_info": {
                ...
                "virtualization_enabled": cpu.VirtualizationFirmwareEnabled if hasattr(cpu, 'VirtualizationFirmwareEnabled') else None
            }
        }
    except Exception as e:
