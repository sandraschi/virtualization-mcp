...
class VMNetworkingService:
    ...
    def add_port_forwarding_rule(
        ...
        Returns:
            NetworkOperationResult with the operation status
        """
        return self.forwarding.add_port_forwarding_rule(
            vm_name, adapter_number, rule
        )
    ...
    def remove_port_forwarding_rule(
        ...
        Returns:
            NetworkOperationResult with the operation status
        """
        return self.forwarding.remove_port_forwarding_rule(
            vm_name, adapter_number, rule_name
        )
