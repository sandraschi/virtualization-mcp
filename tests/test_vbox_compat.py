...
from virtualization_mcp.vbox.compat_adapter import get_vbox_manager, VBoxManagerError
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('test_vbox_compat.log')
    ]
)
...
def test_vm_lifecycle():
    ...
    try:
        ...
        vbox.create_vm(
            ...
            vram_mb=16,
            storage_controllers=[
                {"name": "SATA Controller", "type": "IntelAhci", "port_count": 2}
            ]
        )
