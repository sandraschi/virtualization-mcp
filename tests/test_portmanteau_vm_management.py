...
class TestVMManagementPortmanteau:
    ...
    async def test_list_vms_action(self, vm_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.list_vms', 
                   new_callable=AsyncMock) as mock_list_vms:
    ...
    async def test_create_vm_action_success(self, vm_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.create_vm', 
                   new_callable=AsyncMock) as mock_create_vm:
    ...
    async def test_start_vm_action_success(self, vm_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.start_vm', 
                   new_callable=AsyncMock) as mock_start_vm:
    ...
    async def test_stop_vm_action_success(self, vm_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.stop_vm', 
                   new_callable=AsyncMock) as mock_stop_vm:
    ...
    async def test_delete_vm_action_success(self, vm_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.delete_vm', 
                   new_callable=AsyncMock) as mock_delete_vm:
    ...
    async def test_clone_vm_action_success(self, vm_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.clone_vm', 
                   new_callable=AsyncMock) as mock_clone_vm:
            mock_clone_vm.return_value = mock_result
            
            result = await vm_management_tool(
                action="clone",
                source_vm="SourceVM",
                new_vm_name="ClonedVM"
            )
            ...
            assert result['data'] == mock_result
            mock_clone_vm.assert_called_once_with(
                source_vm="SourceVM",
                new_vm_name="ClonedVM"
            )
    ...
    async def test_reset_vm_action_success(self, vm_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.reset_vm', 
                   new_callable=AsyncMock) as mock_reset_vm:
    ...
    async def test_pause_vm_action_success(self, vm_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.pause_vm', 
                   new_callable=AsyncMock) as mock_pause_vm:
    ...
    async def test_resume_vm_action_success(self, vm_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.resume_vm', 
                   new_callable=AsyncMock) as mock_resume_vm:
    ...
    async def test_get_vm_info_action_success(self, vm_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.get_vm_info', 
                   new_callable=AsyncMock) as mock_get_vm_info:
    ...
    async def test_all_actions_require_vm_name_except_list(self, vm_management_tool):
        ...
        actions_requiring_vm_name = [
            'create', 'start', 'stop', 'delete', 'reset', 
            'pause', 'resume', 'info'
        ]
