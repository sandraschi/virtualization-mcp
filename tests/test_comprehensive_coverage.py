...
class TestExceptions:
    ...
    def test_vbox_exception_import(self):
        ...
        from virtualization_mcp.exceptions import VMError, VMNotFoundError, InvalidStateError
...
class TestToolModules:
    ...
    def test_vm_tools_import(self):
        """Test VM tools."""
        from virtualization_mcp.tools.vm.vm_tools import list_vms, create_vm, start_vm
    ...
    def test_snapshot_tools_import(self):
        """Test snapshot tools."""
        from virtualization_mcp.tools.snapshot.snapshot_tools import list_snapshots, create_snapshot
...
class TestSecurityTools:
    ...
    def test_malware_tools_import(self):
        """Test malware tools."""
        from virtualization_mcp.tools.security.malware_tools import analyze_file, get_malware_analyzer
...
class TestMonitoringTools:
    ...
    def test_metrics_tools_import(self):
        """Test metrics tools."""
        from virtualization_mcp.tools.monitoring.metrics_tools import get_metrics, record_api_request
