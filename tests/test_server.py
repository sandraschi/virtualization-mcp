...
def mock_vbox_manager():
    ...
    with patch("virtualization_mcp.vbox.manager.VBoxManager") as mock:
        # Configure the mock
...
def mock_template_manager():
    ...
    with patch("virtualization_mcp.services.template_manager.TemplateManager") as mock:
        # Configure the mock
...
class TestMainFunction:
    ...
    @patch("virtualization_mcp.services.template_manager.TemplateManager")
    @patch("virtualization_mcp.vbox.manager.VBoxManager")
