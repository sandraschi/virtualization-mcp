...
class TestNetworkManagementPortmanteau:
    ...
    async def test_list_networks_action_success(self, network_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.network_management.list_hostonly_networks', 
                   new_callable=AsyncMock) as mock_list_networks:
    ...
    async def test_create_network_action_success(self, network_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.network_management.create_hostonly_network', 
                   new_callable=AsyncMock) as mock_create_network:
    ...
    async def test_remove_network_action_success(self, network_management_tool):
        ...
        with patch('virtualization_mcp.tools.portmanteau.network_management.remove_hostonly_network', 
                   new_callable=AsyncMock) as mock_remove_network:
    ...
    def test_network_actions_constant(self):
        ...
        expected_actions = {
            ...
            "list_adapters", "configure_adapter"
        }
