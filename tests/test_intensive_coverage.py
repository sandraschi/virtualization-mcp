...
class TestVMTypesModule:
    ...
    def test_types_import(self):
        ...
        from virtualization_mcp.services.vm.types import StorageControllerType, StorageBus
...
class TestPortmanteauInternals:
    ...
    async def test_vm_management_create_path(self):
        ...
        with patch('virtualization_mcp.tools.portmanteau.vm_management.create_vm', new_callable=AsyncMock) as mock_create:
