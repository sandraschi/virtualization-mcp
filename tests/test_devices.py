...
from virtualization_mcp.services.vm.types import DeviceType, USBDeviceFilter
...
class TestVMDeviceMixin:
    ...
    def test_attach_usb_device(self, mock_vbox):
        ...
        # Call the method
        result = self.devices.attach_usb_device(
            self.vm_name,
            usb_device,
            port=1
        )
    ...
    def test_detach_usb_device(self, mock_vbox):
        ...
        # Call the method
        result = self.devices.detach_usb_device(
            self.vm_name,
            usb_filter
        )
    ...
    def test_remove_shared_folder(self, mock_vbox):
        ...
        # Call the method
        result = self.devices.remove_shared_folder(
            self.vm_name,
            "shared-data"
        )
