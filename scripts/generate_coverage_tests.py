...
def main():
    ...
    target_modules = [
        ...
        ('virtualization_mcp.tools.system.system_tools', src_dir / 'tools' / 'system' / 'system_tools.py'),
        ('virtualization_mcp.tools.snapshot.snapshot_tools', src_dir / 'tools' / 'snapshot' / 'snapshot_tools.py'),
        ('virtualization_mcp.tools.storage.storage_tools', src_dir / 'tools' / 'storage' / 'storage_tools.py'),
    ]
