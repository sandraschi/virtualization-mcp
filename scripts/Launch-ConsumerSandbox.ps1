...
if ($existingProcs) {
    ...
    # teardown can genuinely exceed 2s, and launching a new sandbox while the old
    # one is still shutting down violates the singleton constraint this code
    # exists to enforce (TRAPS_AND_PITFALLS.md #36). Poll.
